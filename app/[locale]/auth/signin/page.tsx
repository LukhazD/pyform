                ...
                <CardBody className="px-0 py-0 overflow-visible">
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="relative flex py-2 items-center">
                            ...
                            <span className="flex-shrink-0 mx-4 text-gray-400 text-xs">{t("orEmail")}</span>
                            <div className="flex-grow border-t border-gray-200"></div>
                        </div>
                        ...
                        <form onSubmit={handleEmailSignIn} className="flex flex-col gap-4">
                            ...
                            >
                                {isLoading ? t("sendingLink") : t("getMagicLink")}
                            </Button>

                            <p className="text-xs text-gray-500 text-center mt-2 px-4 leading-relaxed">
                                {t("termsNotice")} <a href="#" className="underline hover:text-gray-900">{t("termsOfService")}</a> {t("and")} <a href="#" className="underline hover:text-gray-900">{t("privacyPolicy")}</a>.
                            </p>
                        </form>
                    </div>
                </CardBody>
