...
export default async function SettingsPage() {
    ...
    const whatsappMessage = encodeURIComponent(t("whatsappHelp", { appName: config.appName, email: session.user?.email || "" }));
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <div className="flex items-center gap-2 px-3 py-1.5 bg-white/10 rounded-lg backdrop-blur-sm">
                                        ...
                                        <span className="text-sm text-gray-300">{t("activeAccount")}</span>
                                    </div>
                                    <div className="flex items-center gap-2 px-3 py-1.5 bg-white/10 rounded-lg backdrop-blur-sm">
                                        <Shield size={14} className="text-green-400" />
                                        <span className="text-sm text-gray-300">{t("verified")}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
